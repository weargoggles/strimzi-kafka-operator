...
:DockerZookeeper: strimzi/zookeeper:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafka: strimzi/kafka:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaConnect: strimzi/kafka-connect:{DockerTag}-kafka-{DefaultKafkaVersion}
:DockerKafkaConnectS2I: strimzi/kafka-connect-s2i:{DockerTag}-kafka-{DefaultKafkaVersion}
